                ...
                <div className="flex flex-col md:flex-row justify-center items-center md:items-start overflow-hidden">
                    ...
                    <div className="order-1 md:order-2 ">
                        ...
                        <p className="px-4 sm:px-16 pb-8 font-bold">
                            ...
                            creating web apps and mobile apps using Meta's technology "React" and "React Native" as well as many coding languages such as Python , Java , C++ , C , and many more. 
